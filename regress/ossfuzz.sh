...
mkdir build
cd build
cmake -DLIBZIP_BUILD_SHARED_LIBS=OFF -DLIBZIP_ENABLE_GNUTLS=OFF -DLIBZIP_ENABLE_MBEDTLS=OFF -DLIBZIP_ENABLE_OPENSSL=OFF -DLIBZIP_BUILD_TOOLS=OFF -DLIBZIP_ENABLE_LZMA=OFF ..
make -j$(nproc)
